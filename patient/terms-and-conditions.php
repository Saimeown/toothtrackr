...
<head>
    ...
    <title>Terms and Conditions - ToothTrackr</title>
      <style>
        .terms-wrapper {
        ...
        <div class="terms-container">
            ...
            <div class="terms-content">
                <section>
                    ...
                    <p>By accessing or using ToothTrackr, you agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you must not use our services.</p>
                </section>

                <section>
                    <h2>2. Description of Service</h2>
                    <p>ToothTrackr provides dental appointment management services through our online platform. We connect patients with dental professionals at Songco Dental and Medical Clinic.</p>
                </section>
                ...
                <section>
                    ...
                    <p>Appointments made through ToothTrackr are subject to the clinic's availability and cancellation policies. Please provide at least 24 hours notice for cancellations.</p>
                </section>

                <section>
                    <h2>6. Medical Information</h2>
                    <p>ToothTrackr is not a substitute for professional medical advice. Always consult with a qualified dental professional regarding any medical conditions or treatments.</p>
                </section>

                <section>
                    <h2>7. Limitation of Liability</h2>
                    <p>ToothTrackr shall not be liable for any direct, indirect, incidental, or consequential damages resulting from the use or inability to use our services.</p>
                </section>
                ...
                <div class="terms-footer">
                    <p>If you have any questions about these Terms and Conditions, please contact us at <a href="mailto:toothtrackr@gmail.com">toothtrackr@gmail.com</a>.</p>
                </div>
