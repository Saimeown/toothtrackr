        ...
        if ($newpassword === $cpassword) {
            ...
            if ($result->num_rows == 1) {
                ...
                try {
                    ...
                    $mail->SMTPAuth = true;
                    $mail->Username = 'songcodent@gmail.com'; // Replace with your email
                    $mail->Password = 'gzdr afos onqq ppnv'; // Replace with your email password
                    ...
                    $verification_link = "http://localhost/Toothtrackr/patient/verify-email.php?token=$verification_token"; // Replace with your domain
        ...
        <div class="container">
            <table>
                <form action="" method="POST" onsubmit="return addCountryCode();">
                    ...
                    <tr>
                        <td class="label-td" colspan="2">
                            <input type="email" name="newemail" placeholder="e.g., juandelacruz@gmail.com" required>
                        </td>
                    </tr>
                    <tr>
                        <td class="label-td" colspan="2">
                    ...
                    <tr>
                        <td class="label-td" colspan="2">
                            ...
                            <div style="display: flex; align-items: center;">
                                <input type="text" id="countryCode" name="countryCode" value="" readonly
                                    style="width: 50px; text-align: center;">
                                <input type="tel" id="tele" name="tele" placeholder="e.g., 9123456789" required>
                            </div>
                        </td>
                    </tr>
