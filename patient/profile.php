...
<head>
    ...
    <title>Profile - ToothTrackr</title>
                            ...
                            <td colspan="4">
                                ...
                                <div class="tabs-container">
                                    <div class="tabs">
                                        ...
                                        <div class="tab" data-tab="medical">Medical Record</div>
                                        <div class="tab" data-tab="dental">Dental Record</div>
                                        <div class="tab" data-tab="forms">Form</div>
                                        <div class="tab" data-tab="consent">Consent Form</div>
                                    </div>
                                        ...
                                        <div id="medical" class="tab-pane">
                                            <?php if ($hasMedicalHistory): ?>
                                                <div class="content-card">
                                                    <div class="card-header">
                                                        ...
                                                        <a href="generate-medical-pdf.php?email=<?php echo urlencode($useremail); ?>" class="download-btn" style="margin-left: auto;">
                                            ...
                                            <?php else: ?>
                                                <div class="empty-state">
                                                    ...
                                                    <p>No medical history records found yet.</p>
                                                </div>
                                            <?php endif; ?>
                                        </div>
