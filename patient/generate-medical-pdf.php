...
$pdf->SetAuthor('Songco Dental and Medical Clinic');
...
$pdf->MultiCell(0, 5, 'I hereby certify that the information contained in this medical record is accurate and complete to the best of my knowledge. This document constitutes an official medical record issued by Songco Dental and Medical Clinic.', 0, 'L');
