    ...
    if ($result->num_rows == 1) {
        ...
        if ($checker->num_rows == 1) {
            ...
            try {
                ...
                // Recipients
                $mail->setFrom('songcodent@gmail.com', 'ToothTrackr Admin');
                $mail->addAddress($email, 'Admin');

                // Content
                $mail->isHTML(true);
                $mail->Subject = 'Admin Password Reset Request';
                $reset_link = "http://localhost/Toothtrackr/admin/reset-password.php?token=$token";
...
<head>
    ...
    <title>Forgot Password - ToothTrackr (Admin)</title>
</head>
<body>
    <nav>
        <ul class="sidebar">
