                ...
                <div class="main-section">
                    ...
                    <div class="announcement-post-button">
                        <div class="user-avatar">
                            <img src="../Media/Icon/SDMC Logo.png" alt="Profile" class="poster-photo">
                        </div>
                    ...
                    <div class="announcements">
                        <div class="announcements-content" id="announcementsContent">
                            ...
                            // Base query with doctor photo included
                            $query = "
                                SELECT post_dentist.*, doctor.docname, doctor.photo
                                FROM post_dentist
                                LEFT JOIN doctor ON post_dentist.docid = doctor.docid
                                UNION ALL
                                SELECT post_admin.*, NULL AS docname, NULL AS photo
                                FROM post_admin
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($post = $result->fetch_assoc()) {
                                    ...
                                    $posterName = $post['docname'] ? $post['docname'] : 'Songco Dental and Medical Clinic';
